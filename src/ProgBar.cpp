// ProgBar.cpp: Implementation of DLL exports.
...
class ProgBarModule :
    public CAtlDllModuleT<ProgBarModule>
{

public:
  #ifdef UNICODE
		DECLARE_LIBID(LIBID_ProgBarLibU)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_PROGBAR, "{80262279-AC7F-4776-B1FD-7BD07073D2F8}")
	#else
		DECLARE_LIBID(LIBID_ProgBarLibA)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_PROGBAR, "{76C5F15C-E571-4869-9BD1-D8C1F5C74946}")
	#endif
};

ProgBarModule _AtlModule;
