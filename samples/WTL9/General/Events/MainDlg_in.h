...
#import <libid:52D76F35-4551-4c56-B53B-A343E42B0AF8> version("{%VER_MAJOR%}.{%VER_MINOR%}") raw_dispinterfaces
#import <libid:74B9FB9B-58D2-4789-9052-ED4EF2ADA75F> version("{%VER_MAJOR%}.{%VER_MINOR%}") raw_dispinterfaces
...
class CMainDlg :
    ...
    public IDispEventImpl<IDC_PROGBARU, CMainDlg, &__uuidof(ProgBarLibU::_IProgressBarEvents), &LIBID_ProgBarLibU, {%VER_MAJOR%}, {%VER_MINOR%}>,
    public IDispEventImpl<IDC_PROGBARA, CMainDlg, &__uuidof(ProgBarLibA::_IProgressBarEvents), &LIBID_ProgBarLibA, {%VER_MAJOR%}, {%VER_MINOR%}>
{
public:
