...
LRESULT CMainDlg::OnDestroy(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
	if(controls.progBarU) {
		IDispEventImpl<IDC_PROGBARU, CMainDlg, &__uuidof(ProgBarLibU::_IProgressBarEvents), &LIBID_ProgBarLibU, {%VER_MAJOR%}, {%VER_MINOR%}>::DispEventUnadvise(controls.progBarU);
		controls.progBarU.Release();
	}
	if(controls.progBarA) {
		IDispEventImpl<IDC_PROGBARA, CMainDlg, &__uuidof(ProgBarLibA::_IProgressBarEvents), &LIBID_ProgBarLibA, {%VER_MAJOR%}, {%VER_MINOR%}>::DispEventUnadvise(controls.progBarA);
...
LRESULT CMainDlg::OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	...
	if(controls.progBarU) {
		IDispEventImpl<IDC_PROGBARU, CMainDlg, &__uuidof(ProgBarLibU::_IProgressBarEvents), &LIBID_ProgBarLibU, {%VER_MAJOR%}, {%VER_MINOR%}>::DispEventAdvise(controls.progBarU);
	...
	if(controls.progBarA) {
		IDispEventImpl<IDC_PROGBARA, CMainDlg, &__uuidof(ProgBarLibA::_IProgressBarEvents), &LIBID_ProgBarLibA, {%VER_MAJOR%}, {%VER_MINOR%}>::DispEventAdvise(controls.progBarA);
